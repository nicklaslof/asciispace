class Input{
    ...
    tick(game, deltaTime){
        ...
        if (gp != null){
            ...
            if (gp.axes[1] <-0.4) this.axes.y = gp.axes[1];
            if (gp.buttons[1].pressed) this.firePressed = true;
            if (gp.buttons[5].pressed && !this.usePressedPreviously) this.usePressed = true;
            this.usePressedPreviously = gp.buttons[5].pressed;
        }else{
