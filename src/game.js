...
class Game{
    ...
    playShoot2(){
        zzfx(20000,...[1,,151,.02,.02,,,1.7,2.8,,,,,,,.1,.16,.78,.02,.23]); // Shoot 124
    }
    ...
    playBossExplosion(){
        zzfx(20000,...[1.57,0,571,.04,.25,1.78,4,4.76,.4,.4,,,,,,.5,.17,.8,.08,.09]); // Explosion 445
    }

    playCheckpoint(){
        zzfx(20000,...[,,581,.05,.64,.15,1,.69,,,-65,.02,.1,,,,.25,,.06,.1]); // Powerup 503
    }
    ...
    playTextBeep(){
        zzfx(20000,...[,,1e3,,.03,.04,2,10.1,,,,,.2,,,,,.1,.02]); // Music 635
    }
