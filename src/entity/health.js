...
class Health extends CollisionEntity{
    ...
    tick(game, deltaTime){
        ...
        if (this.getRandom(0,20)){
            game.level.addEntity(new Particle(this.getRandom(this.position.x-20,this.position.x+20), this.getRandom(this.position.y-15, this.position.y+15),0xff0000ff,true,5,5).setHealth(40));
        }
    }
}
