zzfxV=.3
zzfx=
(lp = 20000,p=1,k=.05,b=220,e=0,r=0,t=.1,q=0,D=1,u=0,y=0,v=0,z=0,l=0,E=0,A=0,F=0,c=0,w=1,m=0,B=0)=>{let
...
+1)%2),n&&++n>z&&(b+=v,C+=v,n=0),!l||++I%l||(b=C,u=G,n=n||1);p=zzfxX.createBuffer(1,h,R);e=zzfxX.createBiquadFilter();
e.connect(zzfxX.destination);p.getChannelData(0).set(k);e.frequency.value = lp;b=zzfxX.createBufferSource();
b.buffer=p;b.connect(e);b.start();return b};zzfxX=new (window.AudioContext||webkitAudioContext)