    ...
    addEntityToTile(game,entity){
        ...
        if (entity.type == "b") {
            for (let index = 0; index < 20; index++) {
                game.level.addParticle(new Particle(entity.getRandom(entity.position.x-20/entity.maxHealth,entity.position.x+20/entity.maxHealth), entity.getRandom(entity.position.y-20/entity.maxHealth, entity.position.y+20/entity.maxHealth),entity.c,true,3,3).setHealth(90));
            }
        }
    }
